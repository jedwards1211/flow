...
type ReactDOM$HTMLElementJSXIntrinsic = {instance: HTMLElement, props: {children?: React$Node, [key: string]: any}};
type ReactDOM$SVGElementJSXIntrinsic = {instance: Element, props: {children?: React$Node, [key: string]: any}};
